...
// One PorkChop recap per channel, per completed (UTC) day, PER SOURCE (text vs voice are summarized
// as separate entities). Generated lazily on first view and cached.
public class DailyChatSummary
{
    public int Id { get; set; }
    public int ChannelId { get; set; }
    public DateTime Date { get; set; }            // UTC calendar day (date component) being summarized
    public MessageSource Source { get; set; }     // which chat stream this recap covers
